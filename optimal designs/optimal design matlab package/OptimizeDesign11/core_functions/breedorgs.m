function [listMat,restMat] = breedorgs(ovf,listMat,alph,varargin)
% function [listMat,restMat] = breedorgs(ovf,listMat,alph,restMatrix [optional])
%
...
mutations = ceil(numStim*numOrgs / 100); 
