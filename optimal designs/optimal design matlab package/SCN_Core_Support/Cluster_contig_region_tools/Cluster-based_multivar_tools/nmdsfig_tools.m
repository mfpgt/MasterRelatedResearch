...
% -----------------------------------------------------------------------
% out = nmdsfig_tools('connect3d',x,y,color,thickness,bendpercent)
% x and y are [x,y,z] coordinate triples, or clusters with mm_center field.
...
function out = connect3d(x,y,color,thickness,bendpercent,varargin)

    % x, y inputs can be [x,y,z] coordinate triplets or clusters.
    if isstruct(x), x = x.mm_center; end
    if isstruct(y), y = y.mm_center; end
