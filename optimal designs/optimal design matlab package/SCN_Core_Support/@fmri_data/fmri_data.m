    ...
    methods
        ...
        function obj = fmri_data(image_names, maskinput, varargin)
            ...
            if sample2mask
                ...
                % ------------------------------------------------ 
                fprintf('Expanding image filenames if necessary\n');
                ...
                switch spm('Ver')
                    ...
                    case {'SPM8', 'SPM5'}
                        imgdat = iimg_get_data(maskobj.volInfo, image_names, 'single', 'verbose', 'noexpand');
                        
                    case {'SPM2', 'SPM99'}
                        % legacy, for old SPM
                        imgdat = iimg_get_data(maskobj.volInfo, image_names, 'single', 'verbose');
            ...
            obj = create(obj, 'mask', maskobj);
            
            % append data
            obj = create(obj, 'dat', imgdat, 'image_names', image_names);
            clear imgdat
            ...
            obj = create(obj, 'mask_descrip', mask_image_name);
