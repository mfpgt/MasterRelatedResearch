...
%                     Distance from hyperplane saved in stats.other_output_cv{:,2}
...
for i = 1:length(varargin)
    if ischar(varargin{i})
        switch varargin{i}
            % functional commands
            case {'nfolds', 'error_type', 'algorithm_name', 'useparallel'}
...
function [yfit, w, dist_from_hyplane, svmpar] = cv_svm(xtrain, ytrain, xtest, cv_assignment, varargin)
%NOTES:
