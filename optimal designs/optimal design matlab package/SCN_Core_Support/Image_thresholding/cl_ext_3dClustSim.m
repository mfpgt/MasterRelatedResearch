function [cl_ext_ClustSim, fwhm] = cl_ext_3dClustSim(corrected_p, prim_p, residual_images, mask, voxelsize_mm, ClustSim_dir, varargin)
...
% fwhm (x, y, z in voxels) - intrinsic smoothness level estimated by AFNI(3dFWHMx). 
