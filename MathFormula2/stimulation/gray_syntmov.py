...
#screen_colour = _globals.screen.colour
#_globals.screen.colour = [240, 240, 240]
### init ###
control.initialize(exp)


#%%
#def __init__(colour =(240,240,240))marche pas je dois pas bien definir les parametres d initailisation
#exp.screen.colour(240, 240, 240)
#expyriment.screen
#bggray = exp.screen(colour=(240, 240, 240))
#bggray.preload()
#bggray = expyriment.io.screen(colour=[240, 240, 240])

fixcross = stimuli.FixCross()
fixcross.preload()

fixcrossblue = stimuli.FixCross(colour=(255,0,255), size=(20,20))
...
for i in items:
    stim = stimuli.TextLine(i.decode('utf-8'),
                            ...
                            text_size=28, text_colour=(255,255,255))
