...
prime_time = 200
max_response_time = 3000 + prime_time + target_prime_interval
...
#	print(exp.clock.stopwatch_time)
	...
	#interval between cross and target
	...
	response_time = exp.clock.stopwatch_time
	print response_time
	#save trial results
	exp.data.add([target_present_time,df["target"][stimIndex],prime_present_time,df["prime"][stimIndex],key,response_time])
	exp.keyboard.clear()
